...
const Production = (props) => {
    ...
    const downloadAsPDF = () => {
        ...
        let tableContent = tableData.map((obj) => {
            ...
            side = obj.OE + "_" + side;
            return [side, item, obj.No_of_Rotors, obj.Delivery, obj.Hours, round(obj.Target, 0), {
                content: obj.Actual_Pro,
                styles: {
                    textColor: [0, 150, 199],
                    fontSize: 24
                }},{
                content: round(obj.Eff, 0) + "%",
                styles: {
                    textColor: [0, 150, 199],
                    fontSize: 24
                }} , time]
    ...
    for (let [key, value] of colorCount) {
        ...
        finalArray.push([item, round(value.target, 0), {
            content: round(value.actual, 0),
            styles: {
                textColor: [0, 150, 199],
                fontSize: 24
            }
        }, {
            content: round(total, 0) + "%",
            styles: {
                textColor: [0, 150, 199],
                fontSize: 24
            }
